...
public:
    ...
    // Pop an item, throw an exception if the stack is empty
    void pop()
    {
        if (empty())
        {
            throw std::out_of_range("Stack is empty! Unable to pop");
        }
        else
        {
            _num_items--;
    ...
    // Access the top-most item, throw an exception if the stack is empty
    std::string top()
    {
        if (empty())
        {
            throw std::out_of_range("Stack is empty! Unable to top");
            return NULL;
        }
        else
